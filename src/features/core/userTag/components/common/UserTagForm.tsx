// src/features/userTag/components/common/UserTagForm.tsx
...
import { UserTagFields } from "./UserTagFields";

export type UserTagFormProps<TFieldValues extends FieldValues> = {
...
export function UserTagForm<TFieldValues extends FieldValues>({
  methods,
  onSubmitAction,
  isMutating = false,
  submitLabel,
