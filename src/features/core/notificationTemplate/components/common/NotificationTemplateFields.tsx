// src/features/notificationTemplate/components/common/NotificationTemplateFields.tsx
...
export type NotificationTemplateFieldsProps<TFieldValues extends FieldValues> = {
...
export function NotificationTemplateFields<TFieldValues extends FieldValues>({
  methods,
  onMediaStateChange,
  fieldPatches,
  ...
  beforeGroup,
  afterGroup,
}: NotificationTemplateFieldsProps<TFieldValues>) {
  return (
    <FieldRenderer
