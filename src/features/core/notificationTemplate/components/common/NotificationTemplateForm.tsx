// src/features/notificationTemplate/components/common/NotificationTemplateForm.tsx
...
import { NotificationTemplateFields } from "./NotificationTemplateFields";

export type NotificationTemplateFormProps<TFieldValues extends FieldValues> = {
...
export function NotificationTemplateForm<TFieldValues extends FieldValues>({
  methods,
  onSubmitAction,
  isMutating = false,
  submitLabel,
  ...
  afterGroup,
  autoSave,
}: NotificationTemplateFormProps<TFieldValues>) {
  return (
    <AppForm
      methods={methods}
      ...
      autoSave={autoSave}
    >
      <NotificationTemplateFields<TFieldValues>
        methods={methods}
