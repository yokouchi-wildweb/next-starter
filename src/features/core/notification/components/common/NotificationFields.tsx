// src/features/notification/components/common/NotificationFields.tsx
...
export function NotificationFields<TFieldValues extends FieldValues>({
  methods,
  onMediaStateChange,
  fieldPatches,
  ...
  beforeField,
  afterField,
}: NotificationFieldsProps<TFieldValues>) {
