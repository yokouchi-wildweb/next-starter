// src/features/notification/components/common/NotificationForm.tsx
...
export type NotificationFormProps<TFieldValues extends FieldValues> = {
...
export function NotificationForm<TFieldValues extends FieldValues>({
  methods,
  onSubmitAction,
  isMutating = false,
  submitLabel,
  ...
  afterGroup,
  autoSave,
}: NotificationFormProps<TFieldValues>) {
  return (
    <AppForm
      methods={methods}
      ...
      autoSave={autoSave}
    >
      <NotificationFields<TFieldValues>
        methods={methods}
