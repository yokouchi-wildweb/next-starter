// src/features/chatRoom/components/common/ChatRoomFields.tsx
...
export function ChatRoomFields<TFieldValues extends FieldValues>({
  methods,
  onMediaStateChange,
  fieldPatches,
  ...
  beforeField,
  afterField,
}: ChatRoomFieldsProps<TFieldValues>) {
  return (
    <FieldRenderer
