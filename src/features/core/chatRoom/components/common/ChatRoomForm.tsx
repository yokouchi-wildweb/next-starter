// src/features/chatRoom/components/common/ChatRoomForm.tsx
...
import { ChatRoomFields } from "./ChatRoomFields";

export type ChatRoomFormProps<TFieldValues extends FieldValues> = {
...
export function ChatRoomForm<TFieldValues extends FieldValues>({
  methods,
  onSubmitAction,
  isMutating = false,
  submitLabel,
  ...
  afterGroup,
  autoSave,
}: ChatRoomFormProps<TFieldValues>) {
  return (
    <AppForm
      methods={methods}
